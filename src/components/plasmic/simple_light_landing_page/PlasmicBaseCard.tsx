...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: aSxk8CC3wCyLN9/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ufoNy, {
          [sty.freeBoxlong__ufoNyVo5F5]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__lB2U, {
            [sty.freeBoxlong__lB2Uvo5F5]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___8ZLK)}
                role={"img"}
              />
            ),
