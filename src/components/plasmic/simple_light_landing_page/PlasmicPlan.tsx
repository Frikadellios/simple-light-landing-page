...
import BaseCard from "../../BaseCard"; // plasmic-import: aSxk8CC3wCyLN9/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: iRRPTIX2nsL-BK/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3DWio)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fxPUy)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__hC4D)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__zAv1)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__qoLlN)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__fFwM)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__hWoqq)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__rKRj9)}
