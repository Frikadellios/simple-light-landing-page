...
import Avatar from "../../Avatar"; // plasmic-import: IKb2qCPR8Zi9iN/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: XiZWZOswo-wub0/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: HT1hZXo31indQ4/icon
import profilepicKo1WukEv8Ovx0P from "./images/profilepic.png"; // plasmic-import: Ko1wukEv8ovx0P/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kjpR8)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gplBf)}
        >
          <div
            className={classNames(
              projectcss.all,
