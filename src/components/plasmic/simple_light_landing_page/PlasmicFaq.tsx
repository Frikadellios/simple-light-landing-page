...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: E7FTZonbO2mBw6/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lvxHy)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__wFnVf)}>
          <div className={classNames(projectcss.all, sty.freeBox__xoqWc)}>
            {p.renderPlasmicSlot({
