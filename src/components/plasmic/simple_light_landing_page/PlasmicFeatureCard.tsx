...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: ElYB4_DwT6HTb/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__uY02K, {
            [sty.freeBoxlong__uY02KUjsl3]: hasVariant($state, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__szMK, {
              [sty.freeBoxlong__szMKUjsl3]: hasVariant($state, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___3YFz6)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mqcHp, {
          [sty.freeBoxlong__mqcHpUjsl3]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__ga2AI, {
            [sty.freeBoxlong__ga2AIUjsl3]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___3AZwc)}
                role={"img"}
              />
            ),
